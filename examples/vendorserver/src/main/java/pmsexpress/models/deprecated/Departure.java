...
public class Departure implements Serializable
{
    ...
    private final static long serialVersionUID = -6023205537821244958L;
    ...
    public String toString() {
        ...
        sb.append(Departure.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("booked");
        sb.append('=');
